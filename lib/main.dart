                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: Colors.white, // or any other color you'd like for the quote text
                          shadows: [
                            Shadow(
                              blurRadius: 10.0, // Spread of the glow
                              color: Colors.blueAccent, // Glow color
                      ...
                      ElevatedButton(
                        ...
                        child: Text('Get another Quote', style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                      SizedBox(height: 10),
                      ElevatedButton(
                        onPressed: _shareQuote,
                        style: ElevatedButton.styleFrom(backgroundColor: Colors.deepOrange),
                        child: Text('Share Quote', style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                      SizedBox(height: 10),
                      ElevatedButton(
                        onPressed: _addToFavorites,
                        style: ElevatedButton.styleFrom(backgroundColor: Colors.deepOrange),
                        child: Text('Add to Favorites', style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ),
                ),
...
class FavoritesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.black, // Use a dark theme background
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ListTile(
            title: Text(
              favorites[index],
              style: TextStyle(color: Colors.white), // Use white color for text
            ),
          );
        },
      ),
...
class GlowingBorderPainter extends CustomPainter {
  ...
  GlowingBorderPainter({required this.animationValue});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final gradient = SweepGradient(
      ...
      stops: [0.0, 0.16, 0.32, 0.48, 0.64, 0.80, 0.96, 1.0],
    ...
    final path = Path()..addRRect(rrect); // Create a path from the RRect
